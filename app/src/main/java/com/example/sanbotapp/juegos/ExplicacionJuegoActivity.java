...
public class ExplicacionJuegoActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (btnEmpezarJuego != null) btnEmpezarJuego.setOnClickListener(v -> {
            pararVoz();         // ← NUEVO: se calla antes de cambiar de pantalla
            empezarJuego();
        });
    ...
    // ── NUEVO: se calla si el usuario pulsa la flecha de volver atrás ────────
    @Override
    public void onStop() {
        super.onStop();
        pararVoz();
